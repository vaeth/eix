...
void
EixRc::resolve_delayed(const string &key, set<string> *has_delayed)
{
	set<string> visited;
	const char *errtext;
	string errvar;
...
string *
EixRc::resolve_delayed_recurse(const string &key, set<string> *visited, set<string> *has_delayed, const char **errtext, string *errvar)
{
