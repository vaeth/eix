	...
	for(ArgumentReader::const_iterator arg(ar.begin());
		...
		switch(**arg) {
			...
			case O_SELECTED_FILE: USE_TEST;
				test->SelectedFile();
				break;
			case O_SELECTED_FILE_PLAIN: USE_TEST;
				test->SelectedFilePlain();
				break;
			case O_SELECTED_SET: USE_TEST;
				test->SelectedSet();
				break;
			case O_SELECTED_SET_PLAIN: USE_TEST;
				test->SelectedSetPlain();
				break;
			case O_SELECTED_ALL: USE_TEST;
				test->SelectedAll();
				break;
			case O_SELECTED_ALL_PLAIN: USE_TEST;
				test->SelectedAllPlain();
				break;
			case O_WORLD_FILE: USE_TEST;
				test->WorldFile();
				break;
			case O_WORLD_FILE_PLAIN: USE_TEST;
				test->WorldFilePlain();
				break;
			case O_WORLD_SET: USE_TEST;
				test->WorldSet();
				break;
			case O_WORLD_SET_PLAIN: USE_TEST;
				test->WorldSetPlain();
				break;
			case O_WORLD_ALL: USE_TEST;
				test->WorldAll();
				break;
			case O_WORLD_ALL_PLAIN: USE_TEST;
				test->WorldAllPlain();
				break;
			case O_SYSTEM_DEFAULT: USE_TEST;
				test->SetStabilityDefault(PackageTest::STABLE_SYSTEM);
				break;
			case O_SYSTEM_PLAIN_DEFAULT: USE_TEST;
				test->SetStabilityDefault(PackageTest::STABLE_SYSTEM_PLAIN);
				break;
			...
			case O_SYSTEM_LOCAL: USE_TEST;
				...
				break;
			case O_SYSTEM_PLAIN_LOCAL: USE_TEST;
				test->SetStabilityLocal(PackageTest::STABLE_SYSTEM_PLAIN);
				break;
			...
			case O_SYSTEM_NONLOCAL: USE_TEST;
				...
				break;
			case O_SYSTEM_PLAIN_NONLOCAL: USE_TEST;
				test->SetStabilityNonlocal(PackageTest::STABLE_SYSTEM_PLAIN);
				break;
