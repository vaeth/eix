...
const Keywords::Redundant
	...
	Keywords::RED_IN_USE       = 0x0040,
	Keywords::RED_IN_CFLAGS    = 0x0080,
	Keywords::RED_ALL_MASKSTUFF= RED_ALL_MASK|RED_ALL_UNMASK|RED_IN_USE|RED_IN_CFLAGS;
