...
std::string getFullInstalled(const Package &p, const PrintFormat &fmt, bool with_slots, char full);
...
void print_version(const PrintFormat *fmt, const Version *version, const Package *package, bool with_slots, char full);
void print_versions_versions(const PrintFormat *fmt, const Package *p, bool with_slots, char full, const std::vector<Version*> *versions);
void print_versions_slots(const PrintFormat *fmt, const Package *p, bool with_slots, char full, const std::vector<Version*> *versions);
void print_versions(const PrintFormat *fmt, const Package *p, bool with_slot, char full);
